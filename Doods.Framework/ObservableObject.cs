...
using System.Text;
using Doods.Framework.Interfaces;
using Doods.Framework.System.ComponentModel;
...
namespace Doods.Framework
{
    ...
    public class ObservableObject : INotifyPropertyChanged
    {
        ...
        internal bool SetProperty<T>(ref T currentValue, T newValue, [CallerMemberName] string propertyName = "")
        {
